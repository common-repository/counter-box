 ...
 *  Plugin Menu:       Counter Box
 *  Rating URI:        https://wordpress.org/support/plugin/counter-box/reviews/?filter=5#new-post
 *  Support URI:       https://wordpress.org/support/plugin/counter-box/
 *  Item URI:          https://wow-estore.com/item/counter-box-pro/
 *  Documentation:     https://wow-estore.com/documentations/counter-box-documentation/
 *
 *  PHP version        7.4
 *
...
use CounterBox\Update\UpdateDB;
...
if ( ! class_exists( 'WOWP_Plugin' ) ) :
	...
	final class WOWP_Plugin {
		...
		// Plugin slug
		public const SLUG = 'counter-box';

		// Plugin prefix
		public const PREFIX = 'counter_box';

		// Plugin Shortcode
		public const SHORTCODE = 'Counter-Box';
		...
		public static function instance(): WOWP_Plugin {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof self ) ) {
				...
				self::$instance->autoloader = new Autoloader( 'CounterBox' );
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_attr__( 'Cheatin&#8217; huh?', 'counter-box' ), '1.0' );
		}
		...
		public function plugin_activate(): void {
			...
			if ( is_plugin_active( 'counter-box-pro/counter-box-pro.php' ) ) {
